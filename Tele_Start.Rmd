...
tc3_log = glm(formula = y ~ age + marital + education + default + housing + loan + contact + month + day_of_week + campaign + previous + poutcome + emp.var.rate + cons.price.idx + cons.conf.idx + euribor3m + nr.employed + pdaysdummy + cluster,
              data = tc3_train_reg,
              family = "binomial")
...
tc4_log = glm(formula = y ~ age + job + marital + education + default + housing + loan + contact + month + day_of_week + campaign + previous + emp.var.rate + cons.price.idx + cons.conf.idx + euribor3m + nr.employed + pdaysdummy + cluster,
              data = tc4_train_reg,
              family = "binomial")
...
#            prop.chisq=FALSE)
# confusionMatrix(as.factor(tc4_combine_model),
